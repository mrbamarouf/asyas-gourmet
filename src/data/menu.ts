...
export const CATEGORY_ORDER: MenuCategoryGroup[] = [
  ...
  },
  {
    ...
    blurb: {
      en: "*Made By Love Abla's* Authentic Turkish Gözleme & Börek Handcrafted dough delicacies, warm and comforting, blending simplicity with true authenticity.",
